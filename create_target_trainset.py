...
def generate_target_trainset(english_dict,giza_output_file_name,output_file_name):
...
def main():
	...
	#	print(key,val)
	generate_target_trainset(english_tagged_dict,giza_output_file_name,output_file_name)
